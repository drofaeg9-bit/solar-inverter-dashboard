    const UI_TRANSLATIONS = {
      uk: {
        ...
        deviceInformation: 'Інформація про пристрій', protocolVersion: 'Версія протоколу', deviceConfiguration: 'Версія ПЗ плати керування',
        lcdMainPageHelp: 'UP і DOWN перемикають десять інформаційних сторінок P1–P10.',
        lcdP1Help: 'P1 читає денне вироблення тільки з R157 карти Modbus V1.31; без відповіді показується —.',
        lcdP2Help: 'P2 читає загальне вироблення тільки з R158 карти Modbus V1.31; без відповіді показується —.',
        lcdP3Help: 'P3 читає напругу R137 і струм R138 безпосередньо з BMS.', lcdP4Help: 'P4 читає температуру R140 і SOC R139 безпосередньо з BMS.',
        lcdP5Help: 'P5 читає поточну ємність R409 і SOH R408.', lcdP6Help: 'P6 читає точку постійної напруги R411 і поріг вимкнення за низьким SOC R415.',
        lcdP7Help: 'P7 читає максимальні струми розряджання R413 і заряджання R412.', lcdP8Help: 'P8 декодує версію протоколу з R17/R18 і версію ПЗ плати керування з R27/R28.',
        lcdP9Help: 'P9 читає загальну потужність PV R161 і навантаження мережі R95.', lcdP10Help: 'P10 читає струми заряджання від PV1 R159 і PV2 R160.', lcdV131Help: 'Додаткова інформаційна сторінка телеметрії Modbus V1.31. Значення доступні лише для читання.', settingsReadOnly: 'Режим налаштувань недоступний: інструкція не містить безпечних Modbus-адрес для запису.',
        ...
        gaugePickerHelp: 'На панель можна додати всі значення. У графіках залишаються лише лічильники енергоспоживання з часовою шкалою.',
        ...
        periodDay: 'День', periodWeek: 'Тиждень', periodMonth: 'Місяць', periodYear: 'Рік', periodMixed: 'Змішані періоди', chartPeriodValue: 'Період: {period}',
        ...
        selectedSummary: 'Вибрано значень: {count} · {period}',
        ...
        register: 'Регістр', group: 'Група', name: 'Назва', meaning: 'Значення поля', value: 'Значення', raw: 'Сире',
        registerNumber: 'Регістр {number}', operatingStatusCode: 'Код робочого стану {number}',
        availableValues: 'Споживання енергії',
        selectionHelp: 'Виберіть лічильники споживання для панелі та графіків.',
      ...
      ru: {
        ...
        deviceInformation: 'Информация об устройстве', protocolVersion: 'Версия протокола', deviceConfiguration: 'Версия ПО платы управления',
        lcdMainPageHelp: 'UP и DOWN переключают десять информационных страниц P1–P10.',
        lcdP1Help: 'P1 читает дневную выработку только из R157 карты Modbus V1.31; без ответа отображается —.',
        lcdP2Help: 'P2 читает общую выработку только из R158 карты Modbus V1.31; без ответа отображается —.',
        lcdP3Help: 'P3 читает напряжение R137 и ток R138 непосредственно из BMS.', lcdP4Help: 'P4 читает температуру R140 и SOC R139 непосредственно из BMS.',
        lcdP5Help: 'P5 читает текущую ёмкость R409 и SOH R408.', lcdP6Help: 'P6 читает точку постоянного напряжения R411 и порог отключения по низкому SOC R415.',
        lcdP7Help: 'P7 читает максимальные токи разряда R413 и заряда R412.', lcdP8Help: 'P8 декодирует версию протокола из R17/R18 и версию ПО платы управления из R27/R28.',
        lcdP9Help: 'P9 читает общую мощность PV R161 и нагрузку сети R95.', lcdP10Help: 'P10 читает токи заряда от PV1 R159 и PV2 R160.', lcdV131Help: 'Дополнительная информационная страница телеметрии Modbus V1.31. Значения доступны только для чтения.', settingsReadOnly: 'Режим настроек недоступен: инструкция не содержит безопасных Modbus-адресов для записи.',
        ...
        register: 'Регистр', group: 'Группа', name: 'Название', meaning: 'Назначение и расшифровка', value: 'Значение', raw: 'Сырое',
        registerNumber: 'Регистр {number}', operatingStatusCode: 'Код рабочего состояния {number}',
        availableValues: 'Потребление энергии',
        selectionHelp: 'Выберите счётчики потребления для панели и графиков.',
        ...
        chooseGauges: 'Выберите индикаторы', gaugePickerHelp: 'На панель можно добавить все значения. В графиках остаются только счётчики энергопотребления с временной шкалой.',
        ...
        periodDay: 'День', periodWeek: 'Неделя', periodMonth: 'Месяц', periodYear: 'Год', periodMixed: 'Смешанные периоды', chartPeriodValue: 'Период: {period}',
        ...
        selectedSummary: 'Выбрано значений: {count} · {period}',
      ...
      en: {
        ...
        deviceInformation: 'Device information', protocolVersion: 'Protocol version', deviceConfiguration: 'Control-board software version',
        lcdMainPageHelp: 'UP and DOWN browse the ten information pages P1–P10.',
        lcdP1Help: 'P1 reads daily production only from V1.31 Modbus register R157; it shows — when no response is available.',
        lcdP2Help: 'P2 reads total production only from V1.31 Modbus register R158; it shows — when no response is available.',
        lcdP3Help: 'P3 reads voltage R137 and current R138 directly from the BMS.', lcdP4Help: 'P4 reads temperature R140 and SOC R139 directly from the BMS.',
        lcdP5Help: 'P5 reads current capacity R409 and SOH R408.', lcdP6Help: 'P6 reads the constant-voltage point R411 and low-SOC shutdown threshold R415.',
        lcdP7Help: 'P7 reads maximum discharge current R413 and maximum charge current R412.', lcdP8Help: 'P8 decodes the protocol version from R17/R18 and control-board software version from R27/R28.',
        lcdP9Help: 'P9 reads total PV power R161 and grid load R95.', lcdP10Help: 'P10 reads PV1 charging current R159 and PV2 charging current R160.', lcdV131Help: 'Additional Modbus V1.31 telemetry page. Values are read-only.', settingsReadOnly: 'Settings mode is unavailable because the manual provides no safe Modbus write addresses.',
        ...
        register: 'Register', group: 'Group', name: 'Name', meaning: 'Meaning and decoding', value: 'Value', raw: 'Raw',
        registerNumber: 'Register {number}', operatingStatusCode: 'Operating status code {number}',
        availableValues: 'Energy consumption',
        selectionHelp: 'Select consumption counters for the dashboard and charts.',
        ...
        chooseGauges: 'Choose gauges', gaugePickerHelp: 'Every value can be added to the dashboard. Graphs remain limited to energy-consumption counters with a timeline.',
        ...
        periodDay: 'Day', periodWeek: 'Week', periodMonth: 'Month', periodYear: 'Year', periodMixed: 'Mixed periods', chartPeriodValue: 'Period: {period}',
        ...
        selectedSummary: '{count} values selected · {period}',
