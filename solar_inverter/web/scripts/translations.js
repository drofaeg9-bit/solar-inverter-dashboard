    const UI_TRANSLATIONS = {
      uk: {
        ...
        registerCount: 'Отримано: {available} · очікують даних: {waiting} · показано: {shown}', loadMoreRegisters: 'Показати ще ({count})',
      ...
      ru: {
        ...
        lcdP9Help: 'P9 читает общую мощность PV R161 и нагрузку сети R95.', lcdP10Help: 'P10 читает токи заряда от PV1 R159 и PV2 R160.', lcdV131Help: 'Дополнительная информационная страница телеметрии Modbus V1.31. Значения доступны только для чтения.', settingsReadOnly: 'Настройки доступны только для просмотра: эта панель никогда не записывает Modbus-регистры.', registerReadOnly: 'Только чтение', registerMaintenanceReadOnly: 'Служебный регистр · только чтение',
        ...
        registerCount: 'Получено: {available} · ожидают данных: {waiting} · показано: {shown}', loadMoreRegisters: 'Показать ещё ({count})',
      ...
      en: {
        ...
        lcdP9Help: 'P9 reads total PV power R161 and grid load R95.', lcdP10Help: 'P10 reads PV1 charging current R159 and PV2 charging current R160.', lcdV131Help: 'Additional Modbus V1.31 telemetry page. Values are read-only.', settingsReadOnly: 'Settings are view-only: this dashboard never writes Modbus registers.', registerReadOnly: 'Read-only', registerMaintenanceReadOnly: 'Maintenance register · read-only',
        ...
        registerCount: '{available} received · {waiting} awaiting data · {shown} shown', loadMoreRegisters: 'Show more ({count})',
