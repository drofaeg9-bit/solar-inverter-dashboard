    const UI_TRANSLATIONS = {
      uk: {
        ...
        lcdP9Help: 'P9 декодує версію протоколу з R17/R18 і версію ПЗ плати керування з R27/R28.', lcdV131Help: 'Додаткова інформаційна сторінка телеметрії Modbus V1.31. Значення доступні лише для читання.', settingsReadOnly: 'Режим налаштувань недоступний: інструкція не містить безпечних Modbus-адрес для запису.',
        ...
        gaugePickerHelp: 'Вибрані індикатори з\'являться на панелі та на графіках.',
        ...
        chartAria: 'Графік в реальному часі для {label}',
        ...
        gitCommitsTitle: 'Історія комітів Git', gitCommitsHelp: 'Виберіть коміт для створення оновлення', gitCommitsAria: 'Відкрити історію комітів Git',
        generateUpdate: 'Створити оновлення', selectedCommit: 'Вибраний коміт: {hash}',
        githubRepoUrl: 'URL репозиторію GitHub', githubRepoUrlPlaceholder: 'https://github.com/owner/repo', githubRepoUrlHelp: 'Введіть URL репозиторію GitHub для завантаження оновлень',
        githubToken: 'GitHub Token (необов\'язково)', githubTokenPlaceholder: 'ghp_...', githubTokenHelp: 'Потрібно для завантаження з приватних репозиторіїв або збільшення лімітів запитів',
        downloadFromGitHub: 'Завантажити з GitHub',
        updaterHistoryTitle: 'Історія оновлень',
        downloadUpdater: 'Завантажити оновлення', selectedUpdater: 'Вибрано: {hash}',
        gitNotInstalled: 'Git не встановлено', gitInstallButton: 'Встановити Git', gitInstalling: 'Встановлення...', gitInstallSuccess: 'Git успішно встановлено', gitInstallFailed: 'Не вдалося встановити Git',
      ...
      ru: {
        ...
        lcdP9Help: 'P9 декодирует версию протокола из R17/R18 и версию ПО платы управления из R27/R28.', lcdV131Help: 'Дополнительная информационная страница телеметрии Modbus V1.31. Значения доступны только для чтения.', settingsReadOnly: 'Режим настроек недоступен: инструкция не содержит безопасных Modbus-адресов для записи.',
        ...
        gitCommitsTitle: 'История коммитов Git', gitCommitsHelp: 'Выберите коммит для создания обновления', gitCommitsAria: 'Открыть историю коммитов Git',
        generateUpdate: 'Создать обновление', selectedCommit: 'Выбранный коммит: {hash}',
        githubRepoUrl: 'URL репозитория GitHub', githubRepoUrlPlaceholder: 'https://github.com/owner/repo', githubRepoUrlHelp: 'Введите URL репозитория GitHub для загрузки обновлений',
        githubToken: 'GitHub Token (необязательно)', githubTokenPlaceholder: 'ghp_...', githubTokenHelp: 'Требуется для загрузки из приватных репозиториев или увеличения лимитов запросов',
        downloadFromGitHub: 'Загрузить с GitHub',
        updaterHistoryTitle: 'История обновлений',
        downloadUpdater: 'Загрузить обновление', selectedUpdater: 'Выбрано: {hash}',
        gitNotInstalled: 'Git не установлен', gitInstallButton: 'Установить Git', gitInstalling: 'Установка...', gitInstallSuccess: 'Git успешно установлен', gitInstallFailed: 'Не удалось установить Git',
      ...
      en: {
        ...
        lcdP9Help: 'P9 decodes the protocol version from R17/R18 and control-board software version from R27/R28.', lcdV131Help: 'Additional Modbus V1.31 telemetry page. Values are read-only.', settingsReadOnly: 'Settings mode is unavailable because the manual provides no safe Modbus write addresses.',
        ...
        gitCommitsTitle: 'Git commit history', gitCommitsHelp: 'Select a commit to create an update', gitCommitsAria: 'Open Git commit history',
        generateUpdate: 'Generate update', selectedCommit: 'Selected commit: {hash}',
        githubRepoUrl: 'GitHub Repository URL', githubRepoUrlPlaceholder: 'https://github.com/owner/repo', githubRepoUrlHelp: 'Enter the GitHub repository URL to download updates from',
        githubToken: 'GitHub Token (optional)', githubTokenPlaceholder: 'ghp_...', githubTokenHelp: 'Required to download from private repositories or increase rate limits',
        downloadFromGitHub: 'Download from GitHub',
        updaterHistoryTitle: 'Updater history',
        downloadUpdater: 'Download updater', selectedUpdater: 'Selected: {hash}',
        gitNotInstalled: 'Git not installed', gitInstallButton: 'Install Git', gitInstalling: 'Installing...', gitInstallSuccess: 'Git installed successfully', gitInstallFailed: 'Failed to install Git',
