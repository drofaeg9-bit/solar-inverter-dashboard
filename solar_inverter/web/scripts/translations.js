    const UI_TRANSLATIONS = {
      uk: {
        ...
        lcdMainPageHelp: 'Екран за замовчуванням: вхідна та вихідна напруга. UP і DOWN перемикають сторінки P1–P10 у порядку з посібника.',
        lcdP1Help: 'P1: вхідна та вихідна частота.', lcdP2Help: 'P2: напруга батареї та вихідна напруга.',
        lcdP3Help: 'P3: напруга батареї та відсоток навантаження.', lcdP4Help: 'P4: напруга батареї та повна потужність навантаження.',
        lcdP5Help: 'P5: напруга батареї та активна потужність навантаження.', lcdP6Help: 'P6: напруга PV1 та потужність PV1.',
        lcdP7Help: 'P7: сумарний струм заряджання PV та струм розряджання батареї.', lcdP8Help: 'P8: сонячна енергія за день.',
        lcdP9Help: 'P9: сонячна енергія за місяць.', lcdP10Help: 'P10: сонячна енергія за рік.', lcdV131Help: 'Додаткова інформаційна сторінка телеметрії Modbus V1.31. Значення доступні лише для читання.', settingsReadOnly: 'Налаштування переглядаються лише для читання: ця панель ніколи не записує Modbus-регістри.', registerReadOnly: 'Лише читання', registerMaintenanceReadOnly: 'Службовий регістр · лише читання',
      ...
      ru: {
        ...
        lcdMainPageHelp: 'Экран по умолчанию: входное и выходное напряжение. UP и DOWN переключают страницы P1–P10 в порядке из руководства.',
        lcdP1Help: 'P1: входная и выходная частота.', lcdP2Help: 'P2: напряжение батареи и выходное напряжение.',
        lcdP3Help: 'P3: напряжение батареи и процент нагрузки.', lcdP4Help: 'P4: напряжение батареи и полная мощность нагрузки.',
        lcdP5Help: 'P5: напряжение батареи и активная мощность нагрузки.', lcdP6Help: 'P6: напряжение PV1 и мощность PV1.',
        lcdP7Help: 'P7: суммарный ток зарядки PV и ток разряда батареи.', lcdP8Help: 'P8: солнечная энергия за день.',
        lcdP9Help: 'P9: солнечная энергия за месяц.', lcdP10Help: 'P10: солнечная энергия за год.', lcdV131Help: 'Дополнительная информационная страница телеметрии Modbus V1.31. Значения доступны только для чтения.', settingsReadOnly: 'Настройки доступны только для просмотра: эта панель никогда не записывает Modbus-регистры.', registerReadOnly: 'Только чтение', registerMaintenanceReadOnly: 'Служебный регистр · только чтение',
      ...
      en: {
        ...
        lcdMainPageHelp: 'Default screen: input and output voltage. UP and DOWN browse pages P1–P10 in the manual order.',
        lcdP1Help: 'P1: input and output frequency.', lcdP2Help: 'P2: battery voltage and output voltage.',
        lcdP3Help: 'P3: battery voltage and load percentage.', lcdP4Help: 'P4: battery voltage and apparent load power.',
        lcdP5Help: 'P5: battery voltage and active load power.', lcdP6Help: 'P6: PV1 voltage and PV1 power.',
        lcdP7Help: 'P7: combined PV charging current and battery discharge current.', lcdP8Help: 'P8: daily solar energy.',
        lcdP9Help: 'P9: monthly solar energy.', lcdP10Help: 'P10: yearly solar energy.', lcdV131Help: 'Additional Modbus V1.31 telemetry page. Values are read-only.', settingsReadOnly: 'Settings are view-only: this dashboard never writes Modbus registers.', registerReadOnly: 'Read-only', registerMaintenanceReadOnly: 'Maintenance register · read-only',
