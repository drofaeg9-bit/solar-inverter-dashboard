...
REGISTER_CONFIG: dict[int, tuple[str, float, str, bool, str]] = {
    ...
    **{
    ...
    40: ("Режим роботи інвертора", 1.0, "", False, "Система"),
    ...
    89: ("Вихідна напруга AC", 0.1, "V", False, "AC"),
    90: ("Вихідний струм AC", 0.1, "A", False, "AC"),
    91: ("Частота AC", 0.01, "Hz", False, "AC"),
    92: ("Температура інвертора або радіатора", 0.1, "°C", False, "Температура"),
    93: ("Вихідна потужність AC", 10.0, "W", False, "Потужність"),
    ...
    **{
    ...
    144: ("Слово стану BMS 144", 1.0, "", False, "BMS"),
    145: ("Параметр BMS 145", 1.0, "", False, "BMS"),
...
METER_DEFINITIONS = [
    (89, [], "Вихідна напруга AC", 0.0, 300.0, "V"),
    (90, [], "Вихідний струм AC", 0.0, 60.0, "A"),
    (93, [], "Вихідна потужність AC", 0.0, 12000.0, "W"),
...
def normalize(register: int, raw: int) -> tuple[str, str, str, float | None, str]:
    ...
    if register == 40:
        label = "Line Mode (від мережі)" if raw == 12 else f"Код режиму інвертора {raw}"
