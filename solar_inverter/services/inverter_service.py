...
REGISTER_CONFIG: dict[int, tuple[str, float, str, bool, str]] = {
    ...
    **{
    ...
    90: ("Внутрішній сервісний струм інвертора", 1.0, "", False, "Система"),
    ...
    94: ("Коефіцієнт потужності навантаження", 0.01, "", False, "AC"),
    ...
    **{
    ...
    138: ("Струм заряджання акумулятора", 0.1, "A", True, "Батарея"),
    139: ("Рівень заряду батареї BMS", 1.0, "%", False, "BMS"),
    140: ("Температура акумулятора", 0.1, "°C", False, "Температура"),
    141: ("Напруга завершення заряджання", 0.1, "V", False, "Батарея"),
    142: ("Недоступний параметр BMS 142", 1.0, "", True, "BMS"),
    143: ("Недоступний параметр BMS 143", 1.0, "", True, "BMS"),
    144: ("Напруга PV-масиву", 0.1, "V", False, "PV"),
    145: ("Потужність сонячних панелей", 1.0, "W", False, "PV"),
    ...
    **{
    ...
    158: ("Ліміт розряджання Time-of-Use", 1.0, "", False, "Налаштування"),
    ...
    341: ("Поріг захисту за частотою CA_LF3", 0.01, "Hz", False, "Налаштування"),
    ...
    378: ("Ліміт струму заряджання/розряджання", 0.1, "A", False, "Налаштування"),
    379: ("Ліміт струму 379", 0.1, "A", False, "Налаштування"),
    383: ("Верхня напруга батареї, налаштування 383", 0.1, "V", False, "Налаштування"),
    385: ("Ліміт потужності розряджання акумулятора", 1.0, "W", False, "Налаштування"),
    386: ("Налаштування або ліміт потужності", 1.0, "W", False, "Налаштування"),

    401: ("Режим роботи інвертора", 1.0, "", False, "Система"),
    402: ("Статус та аварійні прапорці інвертора", 1.0, "", False, "Система"),
    ...
    415: ("Максимальний струм заряджання від мережі", 1.0, "A", False, "Налаштування"),
...
METER_DEFINITIONS = [
    ...
    (344, [], "Струм батареї BMS, канал 344", -150.0, 150.0, "A"),
    (345, [], "Верхня межа напруги BMS", 40.0, 65.0, "V"),
    (346, [], "Нижня межа напруги BMS 1", 40.0, 65.0, "V"),
    ...
    (415, [], "Максимальний струм заряджання від мережі", 0.0, 150.0, "A"),
...
def normalize(register: int, raw: int) -> tuple[str, str, str, float | None, str]:
    ...
    if register == 401:
        label = "Line Mode (від мережі)" if raw == 2 else f"Код режиму інвертора {raw}"
        return "Режим роботи інвертора", label, "", float(raw), "Система"
