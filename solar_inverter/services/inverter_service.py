...
REGISTER_CONFIG: dict[int, tuple[str, float, str, bool, str]] = {
    ...
    **{
    ...
    143: ("Режим входу інвертора", 1.0, "", False, "Система"),
    144: ("Режим виходу інвертора", 1.0, "", False, "Система"),
    145: ("Режим заряджання інвертора", 1.0, "", False, "Система"),
    ...
    **{
    ...
    343: ("Код верхнього аварійного порога частоти CA_HF1", 1.0, "", True, "AC"),
    344: ("Код верхнього аварійного порога частоти CA_HF2", 1.0, "", True, "AC"),
    345: ("Аварійний поріг частоти CA_LF1", 0.1, "Hz", False, "AC"),
    346: ("Аварійний поріг частоти CA_LF2", 0.1, "Hz", False, "AC"),
...
METER_DEFINITIONS = [
    ...
    (345, [], "Аварійний поріг частоти CA_LF1", 40.0, 70.0, "Hz"),
    (346, [], "Аварійний поріг частоти CA_LF2", 40.0, 70.0, "Hz"),
